...
Original file is located at
    https://colab.research.google.com/drive/1oJJuu9rC1bLmlMOWFdGo7jqpK_Zzr9uz
"""
...
class Window(Frame):
  ...
  def open_file(self):
    ...
    ret, image = cap.read()
    cv2.imwrite('/content/preview.jpg',image)
    self.show_image('/content/preview.jpg')
